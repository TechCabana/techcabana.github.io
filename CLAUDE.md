...
README was cut back to a title, badges, a live link and an overview, so it no longer carries
a Licence section or the third-party credits that used to sit under it.
